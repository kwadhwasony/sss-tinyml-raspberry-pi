#!/usr/bin/env python
# this is the modified/fixed image.py file
# we need to be able to take input form picamera which is not directly
# 	supported by opencv version (4.7?) which is used by edge impulse
